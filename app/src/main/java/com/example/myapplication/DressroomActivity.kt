...
class DressroomActivity : AppCompatActivity() {
    ...
    private var currentWeatherThickness: String = "Medium"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupViews()
        currentWeatherThickness = intent.getStringExtra("WEATHER_THICKNESS") ?: "Medium"
    ...
    private fun filterAndDisplayMatches() {
        ...
        var categoryClothes = allDatabaseClothes.filter {
